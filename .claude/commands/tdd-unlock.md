...
2. Run: `python3 "$CLAUDE_PROJECT_DIR/.claude/bin/tdd_lock.py" unlock --reason "$ARGUMENTS" --class <class>`
...
`python3 "$CLAUDE_PROJECT_DIR/.claude/bin/tdd_lock.py" unlock --force --reason "recovering an orphaned
