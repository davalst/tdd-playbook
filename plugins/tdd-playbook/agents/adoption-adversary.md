...
from the SOURCE material — the path a brand-new user walks — how they would find, reach and understand this without being told — and write that answer down. Then read the artifact and
compare.
