...
from the SOURCE material — the repo's actual subsystems, entry points and registries — which of them this capability MUST touch — and write that answer down. Then read the artifact and
compare.
