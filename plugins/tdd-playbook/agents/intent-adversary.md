...
from the SOURCE material — the requester's VERBATIM words — the requirement list, enumerated before the plan can reframe it (you already do this at §'Your output'; this section is the general form of that rule) — and write that answer down. Then read the artifact and
compare.
