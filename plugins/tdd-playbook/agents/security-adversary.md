...
from the SOURCE material — the change's real attack surface — where an attacker would go, before anyone tells you where the code went — and write that answer down. Then read the artifact and
compare.
