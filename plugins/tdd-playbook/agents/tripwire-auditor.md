...
from the SOURCE material — the plan's deliverables — what BUILT + WIRED + ACTIVATED + EXERCISED would concretely require for each — and write that answer down. Then read the artifact and
compare.
