...
from the SOURCE material — the failure paths in the change — what could fail here at 3am, and who would ever know — and write that answer down. Then read the artifact and
compare.
