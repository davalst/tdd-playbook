...
from the SOURCE material — the code as it stands and what already exists in this repo — what a correct fix, at the right seam, would look like — and write that answer down. Then read the artifact and
compare.
